...
class AddShippingAccountResponse implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $shipping_account_id Shipping Account Id <br />The PRO SHIPPING Identifier assigned to this shipping account.
     *
     * @return $this
     */
     ...
     *
     * @param string $shipping_location_id Shipping Location Id <br />The PRO SHIPPING Identifier assigned to the new location (only populated if new location added).
     *
     * @return $this
     */
