...
/**
 * ManifestsPagedResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ManifestsPagedResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ManifestsPagedResponse';
    ...
    protected static $swaggerTypes = [
        'manifests' => '\AdamToms\RoyalMailV4\Model\Manifest[]',
        'total_count' => 'int'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['manifests'] === null) {
            $invalidProperties[] = "'manifests' can't be null";
        }
     ...
     * Gets manifests
     *
     * @return \AdamToms\RoyalMailV4\Model\Manifest[]
     */
     ...
     * Sets manifests
     *
     * @param \AdamToms\RoyalMailV4\Model\Manifest[] $manifests Manifests <br />The manifests for the requested page only.
     *
     * @return $this
     */
     ...
     * Sets total_count
     *
     * @param int $total_count Total Count <br />The total number of manifests available
     *
     * @return $this
     */
