...
/**
 * RoyalMailLinkShippingAccountLocation Class Doc Comment
 *
 * @category Class
 * @description Royal Mail Link Shipping Account Location
 * @package  AdamToms\RoyalMailV4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RoyalMailLinkShippingAccountLocation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RoyalMailLinkShippingAccountLocation';
     ...
     *
     * @param string $shipping_location_id Shipping Location Identifier <br />PRO SHIPPING Shipping Location Id(assigned by PRO SHIPPING) or Alias(assigned by you).
     *
     * @return $this
     */
