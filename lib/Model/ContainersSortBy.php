...
/**
 * ContainersSortBy Class Doc Comment
 *
 * @category Class
 * @description Sort By
 * @package  AdamToms\RoyalMailV4
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContainersSortBy
{
    /**
     * Possible values of this enum
     */
    const CREATED_DATE_UTC = 'CreatedDateUtc';
    const CONTAINER_ID = 'ContainerId';
    const CARRIER_CODE = 'CarrierCode';
    const SHIPPING_LOCATION_ALIAS = 'ShippingLocationAlias';
    const TOTAL_WEIGHT = 'TotalWeight';
    const TOTAL_SHIPMENTS = 'TotalShipments';
    const TOTAL_PACKAGES = 'TotalPackages';
    /**
