...
/**
 * ContainersPagedResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContainersPagedResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContainersPagedResponse';
    ...
    protected static $swaggerTypes = [
        'containers' => '\AdamToms\RoyalMailV4\Model\Container[]',
        'total_count' => 'int'
    ];
     ...
     * Sets containers
     *
     * @param \AdamToms\RoyalMailV4\Model\Container[] $containers Containers <br />The containers for the requested page only.
     *
     * @return $this
     */
     ...
     * Sets total_count
     *
     * @param int $total_count Total Count <br />The total number of containers available
     *
     * @return $this
     */
