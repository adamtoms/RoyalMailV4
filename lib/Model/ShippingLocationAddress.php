...
class ShippingLocationAddress implements ModelInterface, ArrayAccess
{
     ...
     * Sets line1
     *
     * @param string $line1 First Line Address <br />Up to 50 characters may be allowed, however it is carrier dependent and some carriers may allow less.
     *
     * @return $this
     */
     ...
     * Sets line2
     *
     * @param string $line2 Second Line Address, if applicable <br />Up to 50 characters may be allowed, however it is carrier dependent and some carriers may allow less.
     *
     * @return $this
     */
     ...
     * Sets line3
     *
     * @param string $line3 Third Line Address, if applicable <br />Up to 50 characters may be allowed, however it is carrier dependent and some carriers may allow less.
     *
     * @return $this
     */
     ...
     * Sets town
     *
     * @param string $town Town <br />Up to 50 characters may be allowed, however it is carrier dependent and some carriers may allow less.
     *
     * @return $this
     */
