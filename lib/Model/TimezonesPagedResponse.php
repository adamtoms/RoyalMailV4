...
/**
 * TimezonesPagedResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TimezonesPagedResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TimezonesPagedResponse';
    ...
    protected static $swaggerTypes = [
        'time_zones' => '\AdamToms\RoyalMailV4\Model\Timezone[]',
        'total_count' => 'int'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['time_zones'] === null) {
            $invalidProperties[] = "'time_zones' can't be null";
        }
     ...
     * Gets time_zones
     *
     * @return \AdamToms\RoyalMailV4\Model\Timezone[]
     */
     ...
     * Sets time_zones
     *
     * @param \AdamToms\RoyalMailV4\Model\Timezone[] $time_zones Time zone <br />The time zones for the requested page only.
     *
     * @return $this
     */
     ...
     * Sets total_count
     *
     * @param int $total_count Total Count <br />The total number of time zones available
     *
     * @return $this
     */
