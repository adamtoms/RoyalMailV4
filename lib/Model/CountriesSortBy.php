...
/**
 * CountriesSortBy Class Doc Comment
 *
 * @category Class
 * @description Sort By
 * @package  AdamToms\RoyalMailV4
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CountriesSortBy
{
    /**
     * Possible values of this enum
     */
    const COUNTRY_NAME = 'CountryName';
    const ALPHA2_CODE = 'Alpha2Code';
    const ALPHA3_CODE = 'Alpha3Code';
    const NUMERIC = 'Numeric';
    const COUNTRY_GROUP = 'CountryGroup';
    const POSTCODE_REQUIRED = 'PostcodeRequired';
    const STATE_CODE_REQUIRED = 'StateCodeRequired';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::NUMERIC
            self::COUNTRY_GROUP
            self::POSTCODE_REQUIRED
            self::STATE_CODE_REQUIRED
