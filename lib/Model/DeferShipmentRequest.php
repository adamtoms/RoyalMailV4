...
/**
 * DeferShipmentRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeferShipmentRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeferShipmentRequest';
     ...
     * Sets shipment_id
     *
     * @param string $shipment_id Shipment Id <br />The shipment to apply the change to. <br />             <br />The Shipment Id may be an id or a tracking/barcode number.
     *
     * @return $this
     */
     ...
     * Sets shipment_date
     *
     * @param \DateTime $shipment_date Shipment Date <br />The new date that the packages are being shipped. <br />The date must not be in the past and cannot be more than 28 days in the future. <br />             <br />Accepted Format: YYYY-MM-DD
     *
     * @return $this
     */
